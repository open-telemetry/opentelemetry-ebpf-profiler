...
// (raw_tracepoint type) returns the host-namespace TGID of the current process.
// When tests run in the host PID namespace (the normal case) this must equal os.Getpid().
