...
type Config struct {
	...
	// It supports None (disabled), Auto (translates descendants when kernel BTF layout
	// is available, otherwise Exact), Exact, and Descendants (requires BTF).
	// When PIDNamespaceTranslation is true and Mode is None, it defaults to Auto.
