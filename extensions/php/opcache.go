...
package php // import "go.opentelemetry.io/ebpf-profiler/extensions/php"
...
var (
	...
	_ extensions.Data     = &opcacheData{}
	_ extensions.Instance = &opcacheInstance{}
)
...
func (i *opcacheInstance) Detach(ebpf extensions.EbpfHandler, pid libpf.PID) error {
...
func (i *opcacheInstance) SynchronizeMappings(ebpf extensions.EbpfHandler,
...
func (d *opcacheData) Attach(_ extensions.EbpfHandler, _ libpf.PID, bias libpf.Address,
	rm remotememory.RemoteMemory, cfg extensions.Config,
) (extensions.Instance, error) {
	if cfg.(extensions.PHPConfig).IsDisabled() {
...
func (d *opcacheData) Unload(_ extensions.EbpfHandler) {
}
...
func OpcacheLoader(_ extensions.EbpfHandler, info *extensions.LoaderInfo) (
