...
var (
	...
	_ extensions.Data     = &phpData{}
	_ extensions.Instance = &phpInstance{}
)
...
func (d *phpData) Attach(ebpf extensions.EbpfHandler, pid libpf.PID, bias libpf.Address,
	...
	addrToFunction, err := freelru.New[libpf.Address, *phpFunction](extensions.LruFunctionCacheSize,
...
func (d *phpData) Unload(_ extensions.EbpfHandler) {
}
