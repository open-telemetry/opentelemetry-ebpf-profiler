...
package apmint // import "go.opentelemetry.io/ebpf-profiler/extensions/apmint"
...
func (d data) Attach(ebpf extensions.EbpfHandler, pid libpf.PID,
	bias libpf.Address, rm remotememory.RemoteMemory, cfg extensions.Config,
) (extensions.Instance, error) {
	if cfg.(extensions.BaseConfig).IsDisabled() {
