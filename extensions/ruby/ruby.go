...
var (
	...
	_ extensions.Data     = &rubyData{}
	_ extensions.Instance = &rubyInstance{}
)
...
func (r *rubyData) Attach(ebpf extensions.EbpfHandler, pid libpf.PID, bias libpf.Address,
	rm remotememory.RemoteMemory, cfg extensions.Config,
) (extensions.Instance, error) {
	if cfg.(extensions.RubyConfig).IsDisabled() {
...
func (r *rubyData) Unload(_ extensions.EbpfHandler) {
}
...
func (r *rubyInstance) Detach(ebpf extensions.EbpfHandler, pid libpf.PID) error {
...
func (r *rubyInstance) UpdateLibcInfo(ebpf extensions.EbpfHandler, pid libpf.PID,
