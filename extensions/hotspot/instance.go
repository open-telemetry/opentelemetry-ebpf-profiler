...
func (d *hotspotInstance) getMethod(addr libpf.Address, _ uint32) (*hotspotMethod, error) {
	...
	if sourceFileName == libpf.NullString {
		...
		sourceFileName = extensions.UnknownSourceFile
...
func (d *hotspotInstance) Detach(ebpf extensions.EbpfHandler, pid libpf.PID) error {
	var err error
...
func (d *hotspotInstance) addJitArea(ebpf extensions.EbpfHandler,
...
func (d *hotspotInstance) populateMainMappings(vmd *hotspotVMData,
	ebpf extensions.EbpfHandler, pid libpf.PID,
) error {
	if d.mainMappingsInserted {
...
func (d *hotspotInstance) SynchronizeMappings(ebpf extensions.EbpfHandler,
