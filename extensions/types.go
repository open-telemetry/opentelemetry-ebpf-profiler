...
type Data interface {
	...
	// of it to the ebpf maps. The cfg parameter provides the plugin configuration.
	Attach(ebpf EbpfHandler, pid libpf.PID, bias libpf.Address, rm remotememory.RemoteMemory, cfg Config) (
		Instance, error)
