...
var (
	...
	unknownSource = &v8Source{fileName: extensions.UnknownSourceFile}

	// compiler check to make sure the needed interfaces are satisfied
	_ extensions.Data     = &v8Data{}
	_ extensions.Instance = &v8Instance{}
)
...
func (i *v8Instance) Detach(ebpf extensions.EbpfHandler, pid libpf.PID) error {
...
func (i *v8Instance) SynchronizeMappings(ebpf extensions.EbpfHandler,
...
func (i *v8Instance) getSFI(taggedPtr libpf.Address) (*v8SFI, error) {
	...
	if sfi.funcName == libpf.NullString {
		sfi.funcName = extensions.AnonymousFunctionName
	}
...
func (d *v8Data) Attach(ebpf extensions.EbpfHandler, pid libpf.PID, _ libpf.Address,
	rm remotememory.RemoteMemory, cfg extensions.Config,
) (extensions.Instance, error) {
	if cfg.(extensions.V8Config).IsDisabled() {
	...
	addrToCode, err := freelru.New[libpf.Address, *v8Code](extensions.LruFunctionCacheSize,
		libpf.Address.Hash32)
	if err != nil {
		return nil, err
	}
	addrToSFI, err := freelru.New[libpf.Address, *v8SFI](extensions.LruFunctionCacheSize,
		libpf.Address.Hash32)
	if err != nil {
		return nil, err
	}
...
func (d *v8Data) Unload(_ extensions.EbpfHandler) {
}
