...
package python // import "go.opentelemetry.io/ebpf-profiler/extensions/python"
...
var _ extensions.Data = &pythonData{}

func (d *pythonData) String() string {
	return fmt.Sprintf("Python %d.%d", d.version>>8, d.version&0xff)
}

func (d *pythonData) Attach(_ extensions.EbpfHandler, _ libpf.PID, bias libpf.Address, rm remotememory.RemoteMemory, cfg extensions.Config) (extensions.Instance, error) {
	if cfg.(extensions.PythonConfig).IsDisabled() {
		return nil, extensions.ErrExtensionDisabled
	}

	addrToCodeObject, err := freelru.New[libpf.Address, *pythonCodeObject](extensions.LruFunctionCacheSize,
...
func (d *pythonData) Unload(_ extensions.EbpfHandler) {
}
...
var _ extensions.Instance = &pythonInstance{}
...
func (p *pythonInstance) UpdateLibcInfo(ebpf extensions.EbpfHandler, pid libpf.PID,
...
func (p *pythonInstance) Detach(ebpf extensions.EbpfHandler, pid libpf.PID) error {
	if !p.procInfoInserted {
		return nil
	}
...
func findInterpreterRanges(info *extensions.LoaderInfo, ef *pfelf.File,
