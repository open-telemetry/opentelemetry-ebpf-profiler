...
package dotnet // import "go.opentelemetry.io/ebpf-profiler/extensions/dotnet"
...
func (i *dotnetInstance) addRange(ebpf extensions.EbpfHandler, pid libpf.PID,
...
func (i *dotnetInstance) walkRangeList(ebpf extensions.EbpfHandler, pid libpf.PID,
...
func (i *dotnetInstance) addRangeSection(ebpf extensions.EbpfHandler, pid libpf.PID,
...
func (i *dotnetInstance) walkRangeSectionList(ebpf extensions.EbpfHandler, pid libpf.PID) error {
	vms := &i.d.Get().Types
...
func (i *dotnetInstance) walkRangeSectionMapFragments(ebpf extensions.EbpfHandler, pid libpf.PID,
...
func (i *dotnetInstance) walkRangeSectionMapLevel(ebpf extensions.EbpfHandler, pid libpf.PID,
...
func (i *dotnetInstance) walkRangeSectionMap(ebpf extensions.EbpfHandler, pid libpf.PID) error {
...
func (i *dotnetInstance) Detach(ebpf extensions.EbpfHandler, pid libpf.PID) error {
...
func (i *dotnetInstance) SynchronizeMappings(ebpf extensions.EbpfHandler,
