...
type Config struct {
	...
	//
	// Deprecated: use PIDNamespaceTranslationMode instead.
...
func (cfg *Config) Validate() error {
	...
	if cfg.PIDNamespaceTranslation && cfg.PIDNamespaceTranslationMode == tracer.PIDNamespaceTranslationModeNone {
		cfg.PIDNamespaceTranslationMode = tracer.PIDNamespaceTranslationModeAuto
	} else if cfg.PIDNamespaceTranslationMode != tracer.PIDNamespaceTranslationModeNone {
		cfg.PIDNamespaceTranslation = true
	}
