...
type controllerOption struct {
	...
	reporterFactory      func(cfg *reporter.Config, nextConsumer xconsumer.Profiles) (
...
// WithOnShutdown is a function that allows to configure a function to be called when the
...
// is first observed and when its executable changes. The enricher may read from /proc or other
// sources and store
