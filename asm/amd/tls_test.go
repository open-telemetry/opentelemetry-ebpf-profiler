	...
	testdata := []struct {
		...
		},
		{
			...
			code: []byte{
				...
				0x64, 0x48, 0x8b, 0x04, 0x25, 0x20, 0x00, 0x00, 0x00,
		...
		},
		{
			...
			code: []byte{
				0xf3, 0x0f, 0x1e, 0xfa, // endbr64
				// mov rdx, QWORD PTR fs:[0xfffffffffffffff0]
				0x64, 0x48, 0x8b, 0x14, 0x25, 0xf0, 0xff, 0xff, 0xff,
		...
		},
		{
			...
			code: []byte{
				0xf3, 0x0f, 0x1e, 0xfa, // endbr64
				// mov rax, QWORD PTR [0x10] (no FS prefix)
		...
		},
		{
			...
			code: []byte{
				// mov rax, QWORD PTR fs:[0x2000]
				0x64, 0x48, 0x8b, 0x04, 0x25, 0x00, 0x20, 0x00, 0x00,
				0xc3, // ret
			},
			baseAddr:      0x1000,
