...
func (emc *ebpfMapsCoredump) UpdateInterpreterOffsets(ebpfProgIndex uint16,
	fileID host.FileID, offsetRanges []libpf.Range) error {
...
func (emc *ebpfMapsCoredump) UpdateProcData(t libpf.InterpType, pid libpf.PID,
...
func (emc *ebpfMapsCoredump) DeleteProcData(t libpf.InterpType, pid libpf.PID) error {
	switch t {
	case libpf.Perl:
