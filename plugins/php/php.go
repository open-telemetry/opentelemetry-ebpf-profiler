...
var (
	...
	_ plugins.Data     = &phpData{}
	_ plugins.Instance = &phpInstance{}
)
...
func (d *phpData) Attach(ebpf plugins.EbpfHandler, pid libpf.PID, bias libpf.Address,
	...
	addrToFunction, err := freelru.New[libpf.Address, *phpFunction](plugins.LruFunctionCacheSize,
...
func (d *phpData) Unload(_ plugins.EbpfHandler) {
}
