...
package php // import "go.opentelemetry.io/ebpf-profiler/plugins/php"
...
var (
	...
	_ plugins.Data     = &opcacheData{}
	_ plugins.Instance = &opcacheInstance{}
)
...
func (i *opcacheInstance) Detach(ebpf plugins.EbpfHandler, pid libpf.PID) error {
...
func (i *opcacheInstance) SynchronizeMappings(ebpf plugins.EbpfHandler,
...
func (d *opcacheData) Attach(_ plugins.EbpfHandler, _ libpf.PID, bias libpf.Address,
	rm remotememory.RemoteMemory, cfg plugins.Config,
) (plugins.Instance, error) {
	if cfg.(plugins.PHPConfig).IsDisabled() {
...
func (d *opcacheData) Unload(_ plugins.EbpfHandler) {
}
...
func OpcacheLoader(_ plugins.EbpfHandler, info *plugins.LoaderInfo) (
	plugins.Data, error,
) {
