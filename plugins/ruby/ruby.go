...
var (
	...
	_ plugins.Data     = &rubyData{}
	_ plugins.Instance = &rubyInstance{}
)
...
func (r *rubyData) Attach(ebpf plugins.EbpfHandler, pid libpf.PID, bias libpf.Address,
	rm remotememory.RemoteMemory, cfg plugins.Config,
) (plugins.Instance, error) {
	if cfg.(plugins.RubyConfig).IsDisabled() {
...
func (r *rubyData) Unload(_ plugins.EbpfHandler) {
}
...
func (r *rubyInstance) Detach(ebpf plugins.EbpfHandler, pid libpf.PID) error {
...
func (r *rubyInstance) UpdateLibcInfo(ebpf plugins.EbpfHandler, pid libpf.PID,
