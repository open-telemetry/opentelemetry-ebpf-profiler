...
var (
	...
	unknownSource = &v8Source{fileName: plugins.UnknownSourceFile}

	// compiler check to make sure the needed interfaces are satisfied
	_ plugins.Data     = &v8Data{}
	_ plugins.Instance = &v8Instance{}
)
...
func (i *v8Instance) Detach(ebpf plugins.EbpfHandler, pid libpf.PID) error {
...
func (i *v8Instance) SynchronizeMappings(ebpf plugins.EbpfHandler,
...
func (i *v8Instance) getSFI(taggedPtr libpf.Address) (*v8SFI, error) {
	...
	if sfi.funcName == libpf.NullString {
		sfi.funcName = plugins.AnonymousFunctionName
	}
...
func (d *v8Data) Attach(ebpf plugins.EbpfHandler, pid libpf.PID, _ libpf.Address,
	rm remotememory.RemoteMemory, cfg plugins.Config,
) (plugins.Instance, error) {
	if cfg.(plugins.V8Config).IsDisabled() {
	...
	addrToCode, err := freelru.New[libpf.Address, *v8Code](plugins.LruFunctionCacheSize,
		libpf.Address.Hash32)
	if err != nil {
		return nil, err
	}
	addrToSFI, err := freelru.New[libpf.Address, *v8SFI](plugins.LruFunctionCacheSize,
		libpf.Address.Hash32)
	if err != nil {
		return nil, err
	}
...
func (d *v8Data) Unload(_ plugins.EbpfHandler) {
}
