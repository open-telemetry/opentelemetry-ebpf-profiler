...
package hotspot // import "go.opentelemetry.io/ebpf-profiler/plugins/hotspot"
...
func (d *hotspotData) Attach(_ plugins.EbpfHandler, _ libpf.PID, bias libpf.Address,
	rm remotememory.RemoteMemory, cfg plugins.Config,
) (ii plugins.Instance, err error) {
	if cfg.(plugins.HotspotConfig).IsDisabled() {
	...
	addrToSymbol, err := freelru.New[libpf.Address, libpf.String](2*plugins.LruFunctionCacheSize,
		libpf.Address.Hash32)
	if err != nil {
		return nil, err
	}
	addrToMethod, err := freelru.New[libpf.Address, *hotspotMethod](plugins.LruFunctionCacheSize,
		libpf.Address.Hash32)
	if err != nil {
		return nil, err
	}
	addrToJITInfo, err := freelru.New[libpf.Address, *hotspotJITInfo](plugins.LruFunctionCacheSize,
		libpf.Address.Hash32)
	if err != nil {
		return nil, err
	}
...
func (d *hotspotData) Unload(_ plugins.EbpfHandler) {
}
...
func newHotspotData(filename string, ef *pfelf.File) (plugins.Data, error) {
	d := &hotspotData{}
