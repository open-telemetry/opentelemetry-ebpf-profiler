...
package dotnet // import "go.opentelemetry.io/ebpf-profiler/plugins/dotnet"
...
func (i *dotnetInstance) addRange(ebpf plugins.EbpfHandler, pid libpf.PID,
...
func (i *dotnetInstance) walkRangeList(ebpf plugins.EbpfHandler, pid libpf.PID,
...
func (i *dotnetInstance) addRangeSection(ebpf plugins.EbpfHandler, pid libpf.PID,
...
func (i *dotnetInstance) walkRangeSectionList(ebpf plugins.EbpfHandler, pid libpf.PID) error {
	vms := &i.d.Get().Types
...
func (i *dotnetInstance) walkRangeSectionMapFragments(ebpf plugins.EbpfHandler, pid libpf.PID,
...
func (i *dotnetInstance) walkRangeSectionMapLevel(ebpf plugins.EbpfHandler, pid libpf.PID,
...
func (i *dotnetInstance) walkRangeSectionMap(ebpf plugins.EbpfHandler, pid libpf.PID) error {
...
func (i *dotnetInstance) Detach(ebpf plugins.EbpfHandler, pid libpf.PID) error {
...
func (i *dotnetInstance) SynchronizeMappings(ebpf plugins.EbpfHandler,
