...
func (i *perlInstance) UpdateLibcInfo(ebpf plugins.EbpfHandler, pid libpf.PID,
...
func (i *perlInstance) Detach(ebpf plugins.EbpfHandler, pid libpf.PID) error {
	if !i.procInfoInserted {
		return nil
	}
...
func (i *perlInstance) Symbolize(ef libpf.EbpfFrame, frames *libpf.Frames, _ libpf.FrameMapping) error {
	...
	functionName := plugins.TopLevelFunctionName
